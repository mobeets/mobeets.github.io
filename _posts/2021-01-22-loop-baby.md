...
- Internally, the Loop Baby is a Raspberry Pi (with Raspbian) routing audio through [Sooperlooper](http://sonosaurus.com/sooperlooper/)
- Audio input/output (from a USB audio adapter) connects to the Loop Baby
...
To me, the killer feature is quantization, which means the looper's recording and playback can be quantized to the nearest beat by providing a clock signal (e.g., from a drum machine). This is a feature I couldn't find in a multi-track looper for less than $400 or so.
...
<!-- If a MIDI-USB cable is connected to something providing a clock signal (e.g., from a drum machine or synth), the looper's recording and playback is quantized to the nearest beat. This was, for me, the killer function that I couldn't find in a multi-track looper for less than like $500. -->
...
<img width="100%" style="max-width: 500px;" src="/assets/images/loop-baby/guts.jpg" />
